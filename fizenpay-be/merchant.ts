...
export namespace fizenpay_be {
	export interface MerchantService {
		getAllMerchant(
			data: GetAllMerchantRequest,
			metadata?: Metadata,
		): Observable<GetAllMerchantResponse>;
		activateAccount(
		...
		getOneBySession(
			data: GetOneBySessionRequest,
			metadata?: Metadata,
		): Observable<GetOneBySessionResponse>;
		getOneByApiKey(
			data: GetOneByApiKeyRequest,
			metadata?: Metadata,
		): Observable<GetOneByApiKeyResponse>;
	}
